  ...
  return (
    <div className=' flex flex-col gap-1'>
      ...
      <div className='flex gap-1 flex-col  xl:flex-row'>
        <div className='queen__room flex p-2  bg-white border rounded-sm w-full xl:w-[75%]  '>
          <div className=' bg-center hidden lg:flex bg-cover rounded-lg  w-[42%] bg-[url("https://goodhomes.wwmindia.com/content/2020/dec/ali-bedroom-table-with-rooshad-shroff1607602520.jpg")]'>
            
          </div>
          <div className='p-3 w-full lg:w-[58%] flex flex-col gap-1'>
        ...
        <div className=' bg-white border-4 relative border-primary rounded-lg w-full xl:w-[24%]'>
          <HalfPiaChart/>
          <ul className='absolute flex bottom-8 left-[50%] translate-x-[-50%] gap-3'>
            <li className=' w-10 h-6 bg-primary'></li>
